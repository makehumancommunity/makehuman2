...
```bash
usage: ppabuild.py [-h] [--verbose] [--version VERSION] [--nobins] [--data DATA [DATA ...]] [builddir]
...
optional arguments:
  ...
  --verbose, -v         verbose
  --version VERSION, -V VERSION
                        Version name, it is appended to the reponame to allow extra versions
  --nobins, -n          no binary targets and meshes for development
  --data DATA [DATA ...], -d DATA [DATA ...]
                        Append additional data folders
```
